...
# Launch file for FR3 with MoveIt only (no Gazebo)
# Based on official franka_fr3_moveit_config/launch/moveit.launch.py
...
def generate_launch_description():
    # Launch arguments (exactly like official)
    ...
    robot_arg = DeclareLaunchArgument(
        ...
        description='Hostname or IP address of the robot (not used with fake hardware)')
    ...
    # Robot description (exactly like official)
    ...
    # Robot semantic description (exactly like official)
    ...
    # Controllers (exactly like official)
    ...
    # Joint state publisher - aggregate joint states and republish to /joint_states
    joint_state_publisher = Node(
        ...
        remappings=[('joint_states', '/joint_states')],  # Ensure output goes to /joint_states
    )

    # Franka robot state broadcaster (only for real hardware)
